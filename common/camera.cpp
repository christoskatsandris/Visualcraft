...
Camera::Camera(GLFWwindow* window, vec3 position, float horizontalAngle, float verticalAngle, vector<float> heightMap)
    : window(window), position(position), horizontalAngle(horizontalAngle), verticalAngle(verticalAngle), heightMap(heightMap) {
    FoV = 45.0f;
    speed = 3.0f;
    mouseSpeed = 0.001f;
    fovSpeed = 2.0f;
